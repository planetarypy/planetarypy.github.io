...
BLOG_AUTHOR = "PlanetaryPy Technical Committee"  # (translatable)
BLOG_TITLE = "PlanetaryPy"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://planetarypy.github.io/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://planetarypy.github.io/"
BLOG_EMAIL = "rbeyer@seti.org"
BLOG_DESCRIPTION = "This is a test site for the PlanetaryPy Project."  # (translatable)
...
NAVIGATION_ALT_LINKS = {
    DEFAULT_LANG: (
        ("https://github.com/planetarypy", "GitHub Repo"),
    )
}

# Name of the theme to use.
# nikola subtheme -n spacelab -s spacelab
THEME = "spacelab"
...
RSS_COPYRIGHT = 'Contents © {date} <a href="https://github.com/planetarypy/TC">{author}</a> {license}'
